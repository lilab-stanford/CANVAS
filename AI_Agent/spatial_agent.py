...
class SpatialFeatureAgent:
    ...
    def __init__(self, api_key=None, model_name="gpt-4o", temperature=0.3, 
        ...
        """
        # Use provided defaults from user's GPTBatcher example
        self.api_key = api_key or os.getenv('OPENAI_API_KEY') or "sk-ZSPPKSqqheqOmxhK9a5465F997E047DcB4A7A7901f1cE676"
        self.api_base_url = api_base_url or "https://api.pumpkinaigc.online/v1"
...
- Spatial metrics and statistical methods
...
3. **Spatial Metrics (~90 features)**: Ripley_K/L_mean, G_mean, F_mean, J_mean, Pair_corr_g_mean, Clark_Evans, Quadrat_chisq, Kernel_density_mean
...
- "Explain spatial metrics in general" (educational content)
    ...
    def _show_help(self):
        ...
        categories = [
            ...
            ("Data Queries", [
                ...
                "What spatial metrics are available?"
            ]),
            ("Educational Content", [
